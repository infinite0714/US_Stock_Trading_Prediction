...
# Form implementation generated from reading ui file 'd:\MyCode\Stock_Trading_Bot\US_Stock_Trading_Prediction\dialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.tbxInvested_Money = QtWidgets.QTextEdit(Dialog)
        ...
        self.tbxTotal_Money = QtWidgets.QTextEdit(Dialog)
        ...
        self.btnStart.setGeometry(QtCore.QRect(580, 181, 171, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btnGraphShow.setGeometry(QtCore.QRect(580, 298, 171, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btnShow = QtWidgets.QPushButton(Dialog)
        self.btnShow.setGeometry(QtCore.QRect(577, 88, 171, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btnShow.setText(_translate("Dialog", "Show Result"))
